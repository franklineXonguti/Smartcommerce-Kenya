"""
Base settings for smartcommerce project.
"""
import os
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SmartCommerce Kenya API',
    'DESCRIPTION': 'Production-ready AI-assisted e-commerce platform for Kenya',
    'VERSION': '0.0.1-alpha',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@smartcommerce.co.ke')
